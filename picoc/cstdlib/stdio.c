...
void StdioSetupFunc(void)
{
    ...
    StructFileType = TypeCreateOpaqueStruct(NULL, TableStrRegister("__FILEStruct"), 20);
    // FFFFFFFFUU sizeof(FILE) is impossible in emscripten, so fake it
    ...
    TypeCreateOpaqueStruct(NULL, TableStrRegister("__va_listStruct"), sizeof(struct StdVararg));
